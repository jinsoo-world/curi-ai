...
export const metadata: Metadata = {
    title: '만들기',
    description: '사진 한 장으로 프로필 사진·썸네일·전자책까지. 중장년을 위한 AI 도구 모음입니다.',
    keywords: ['AI 도구', '프로필 사진 만들기', '썸네일 만들기', '중장년 AI', 'AI 사진 편집'],
    openGraph: {
    ...
    twitter: { card: 'summary_large_image', title: '오늘 뭘 만들까요 — 큐리 AI', description: '사진 한 장으로 프로필 사진·썸네일·전자책까지. 중장년을 위한 AI 도구 모음입니다.', images: ['/og/profile-photo.png'] },
