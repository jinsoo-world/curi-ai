...
export const metadata: Metadata = {
    ...
    description: '여권·이력서·주민등록에 내는 규격 증명사진을 사진 한 장으로 만듭니다. 정면·무표정·그림자 없는 배경까지 규격대로.',
    ...
    twitter: { card: 'summary_large_image', title: '증명사진 만들기 — 큐리 AI', description: '여권·이력서·주민등록에 내는 규격 증명사진을 사진 한 장으로 만듭니다. 정면·무표정·그림자 없는 배경까지 규격대로.', images: ['/og/profile-photo.png'] },
