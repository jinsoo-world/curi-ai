...
//
// ⚠️ 숫자를 고칠 때 = 유효기간은 2026-09-21 토스페이먼츠 요청으로 5년 → 1년으로 줄였다.
// 1년은 신유형 상품권 표준약관이 정한 하한선이라 더 줄이면 안 된다. 만료 30일 전 통지도 그 약관이 요구하는 것.
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: 15, lineHeight: 1.8, color: 회색 }}>
                        <p style={{ marginBottom: 24 }}>
                            <strong>시행일:</strong> 2026년 9월 15일 (개정 2026년 9월 21일)
                        </p>
                        ...
                        <조 제목="제4조 (클로버 유효기간)">
                            <p>
                                클로버는 마지막으로 충전한 날로부터 <strong>1년</strong> 동안 쓸 수 있습니다.
                                기간이 끝나기 30일 전에 미리 알려드립니다.
                            </p>
                        </조>
