 ...
 *   500개   25.0원 · 지금 70% · 2027 39.6%
 *   1,000개 19.0원 · 61% · 20.5%   ← 24% 할인
 *   3,000개 15.3원 · 51% · 1.5%    ← 39% 할인. **마지노선**
 *
 * ⚠️ 40% 할인은 개당 15.0원인데 2027-01 원가가 15.1원이라 그 시점에 적자다.
 *    그래서 39% 에서 멈췄다. 2027년이 오기 전에 이 표를 다시 봐야 한다.
 */
