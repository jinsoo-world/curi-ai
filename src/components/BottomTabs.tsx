...
/** 이 띠를 걷는 곳 — 손이 바쁜 화면 */
const 숨김 = ['/os', '/landing', '/tools/teacher-photo', '/tools/id-photo', '/tools/insta-profile', '/tools/actor-photo', '/tools/enhance', '/tools/thumbnail', '/chat/', '/coach/', '/admin', '/login', '/billing', '/charge', '/creator/create', '/creator/edit', '/studio/']
